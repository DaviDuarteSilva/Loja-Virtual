...
<body>
    ...
    <div class="container my-5 pt-5">
        ...
        <p>Esta é sua área pessoal. Navegue pelos menus para gerenciar seu perfil ou ver produtos.</p>
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><i class="fas fa-shopping-bag"></i> Produtos</h5>
                        <p class="card-text">Explore nossa coleção de produtos.</p>
